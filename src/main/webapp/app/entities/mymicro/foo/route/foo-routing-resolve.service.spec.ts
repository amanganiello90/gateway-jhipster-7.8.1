...
describe('Foo routing resolve service', () => {
  ...
  describe('resolve', () => {
    ...
    it('should return new IFoo if id is not provided', () => {
      // GIVEN
      ...
      expect(resultFoo).toEqual(new Foo());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Foo })));
      mockActivatedRouteSnapshot.params = { id: 123 };
