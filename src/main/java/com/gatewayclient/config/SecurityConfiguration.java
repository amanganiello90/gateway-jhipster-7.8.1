package com.gatewayclient.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import com.gatewayclient.security.AuthoritiesConstants;
import com.gatewayclient.security.SecurityUtils;
import com.gatewayclient.security.oauth2.AudienceValidator;
import com.gatewayclient.security.oauth2.JwtGrantedAuthorityConverter;
import com.gatewayclient.web.filter.SpaWebFilter;
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http
            .securityMatcher(new NegatedServerWebExchangeMatcher(new OrServerWebExchangeMatcher(
                pathMatchers("/assets/**","/app/**", "/i18n/**", "/content/**", "/swagger-ui/**", "/v3/api-docs/**", "/test/**"),
